...
<script>
    ...
    function validateForm() {
        ...
        if (firstName === "") {
            document.getElementById("error-messages-first").innerHTML = "<div class='error text-center' style='color:red;'>Please enter your first name.</div>";
        ...
        if (lastName === "") {
            document.getElementById("error-messages-last").innerHTML = "<div class='error text-center' style='color:red;'>Please enter your last name.</div>";
        ...
        if (email === "") {
            document.getElementById("error-messages-email").innerHTML = "<div class='error text-center' style='color:red;'>Please enter your email.</div>";
        ...
        if (password === "") {
            document.getElementById("error-messages-pass1").innerHTML = "<div class='error text-center' style='color:red;'>Please enter your password.</div>";
        ...
        if (confirmPassword === "") {
            document.getElementById("error-messages-pass2").innerHTML = "<div class='error text-center' style='color:red;'>Please confirm your password.</div>";
            document.getElementById('Confirm-Password').classList.add('is-invalid'); // Add 'is-invalid' class to input
            isValid = false;
        } else if (password !== confirmPassword) {
            document.getElementById("error-messages-pass2").innerHTML = "<div class='error text-center' style='color:red;'>Password must match.</div>";
            document.getElementById('Confirm-Password').classList.add('is-invalid'); // Add 'is-invalid' class to input
            isValid = false;
        } else {
        ...
        if (accountType === "") {
            document.getElementById("error-messages-acc").innerHTML = "<div class='error text-center' style='color:red;'>Please select your account type.</div>";
        ...
        if (!/^[a-zA-Z ]+$/.test(firstName)) {
            document.getElementById("error-messages-first").innerHTML = "<div class='error text-center' style='color:red;'>Please enter a valid first name.</div>";
            document.getElementById('first-Name').classList.add('is-invalid'); // Add 'is-invalid' class to input
            isValid = false;
        } else {
            document.getElementById("error-messages-first").innerHTML = "";
        ...
        if (!/^[a-zA-Z ]+$/.test(lastName)) {
            document.getElementById("error-messages-last").innerHTML = "<div class='error text-center' style='color:red;'>Please enter a valid last name.</div>";
            document.getElementById('last-Name').classList.add('is-invalid'); // Add 'is-invalid' class to input
            isValid = false;
        } else {
            document.getElementById("error-messages-last").innerHTML = "";
        ...
        // Validate email
        if (!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(email)) {
            document.getElementById("error-messages-email").innerHTML = "<div class='error text-center' style='color:red;'>Please enter a valid email.</div>";
            document.getElementById('Email').classList.add('is-invalid'); // Add 'is-invalid' class to input
            isValid = false;
        } else {
            document.getElementById("error-messages-email").innerHTML = "";
        ...
        if (password.length < 8) {
            document.getElementById("error-messages-pass1").innerHTML = "<div class='error text-center' style='color:red;'>Password must be at least 8 characters.</div>";
            document.getElementById('Password').classList.add('is-invalid'); // Add 'is-invalid' class to input
            isValid = false;
        } else {
            document.getElementById("error-messages-pass1").innerHTML = "";
