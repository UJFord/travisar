    ...
    <div class="modal-dialog" id="modalDialogEdit">
        <div class="modal-content">
            ...
            <div class="modal-body" id="approve-label">
                Are you sure you want to Edit the user? Please review all credentials for accuracy.
            </div>
            <div class="modal-body" id="delete-label">
                Are you sure you want to Delete the user? This action will remove all associated data.
            </div>
