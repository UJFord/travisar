...
<body>
    ...
    <div class="container">
        <div class="row mt-3">
            ...
            <!-- FILTERS -->
            <?php require "modals/abiotic-tabs/filter.php"; ?>

            <!-- LIST -->
            <?php require "modals/abiotic-tabs/list.php"; ?>

            <!-- MODAL -->
            <!-- add -->
            <?php require "modals/abiotic-tabs/add.php"; ?>
            <!-- edit -->
            <?php require "modals/abiotic-tabs/edit.php"; ?>
