...
<body>
    ...
    <div class="container">
        <div class="row mt-3">
            ...
            <!-- FILTERS -->
            <?php require "modals/terrain-tabs/filter.php"; ?>

            <!-- list -->
            <?php require "modals/terrain-tabs/list.php"; ?>

            <!-- add -->
            <?php require "modals/terrain-tabs/add.php"; ?>

            <!-- edit -->
            <?php require "modals/terrain-tabs/edit.php"; ?>
        </div>
    </div>
