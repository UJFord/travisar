<!-- Other info TAB -->
<div class="fade tab-pane" id="edit-other_info-tab-pane" role="tabpanel" aria-labelledby="edit-other_info-tab" tabindex="0">
    <!-- Type, Name and Description-->
    <div id="otherData">
        <div class="row mb-4 other-info">
            <input id="other_id" type="hidden" name="other_info_id_1">
            <!-- Type -->
            <div class="col-4">
                <label for="Type-Edit" class="form-label small-font">Type</label>
                <input id="Type-Edit" type="text" name="other_info_type_1" class="form-control">
            </div>

            <!-- Aroma -->
            <div class="col-4">
                <label for="Other-Name-Edit" class="form-label small-font">Name</label>
                <input id="Other-Name-Edit" type="text" name="other_info_name_1" class="form-control">
            </div>
            ...
            <div class="col-12 mb-2">
                <label for="Other-Info-Desc-Edit" class="form-label small-font">Description</label>
                <textarea name="other_info_desc_1" id="Other-Info-Desc-Edit" cols="30" rows="2" class="form-control"></textarea>
            </div>
        </div>
    </div>
