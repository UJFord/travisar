    ...
    <div class="row mb-3">
        ...
        <div class="col-6">
            ...
            <div class="form-check form-check-inline">
                ...
                <input class="form-check-input" type="radio" name="texture" id="hardness-Soft-Edit" value="Soft">
            </div>
            <div class="form-check form-check-inline">
                <label class="form-check-label small-font" for="hardness-Hard-Edit">Hard</label>
                <input class="form-check-input" type="radio" name="texture" id="hardness-Hard-Edit" value="Hard">
            </div>
        </div>
    </div>
