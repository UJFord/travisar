...
if (isset($_POST['save'])) {
    ...
    try {
        ...
        $role_in_maintaining_upland_ecosystem = isset($_POST['role_in_maintaining_upland_ecosystem']) ? handleEmpty($_POST['role_in_maintaining_upland_ecosystem']) : "";
        $scientific_name = isset($_POST['scientific_name']) ? handleEmpty($_POST['scientific_name']) : "";
        $unique_features = isset($_POST['unique_features']) ? handleEmpty($_POST['unique_features']) : "";
        $other_category_name = isset($_POST['other_category_name']) ? handleEmpty($_POST['other_category_name']) : "";
