...
<div class="col" style="min-height: 615px; max-height:615px;">
    <div class="container">
        ...
        <div class="d-flex justify-content-between">
            <!-- title -->
            <h4 class="fw-semibold" style="font-size: 1.5rem;">List of Pests</h4>
        ...
        $total_rows_query = "SELECT COUNT(*) FROM pest_resistance";
        ...
        $search_condition = $search ? "AND pest_name ILIKE '%$search%'" : '';
        ?>
        ...
        <table id="dataTable" class="table table-hover">
            ...
            <thead>
                <tr>
                    ...
                    <th class="col text-dark-emphasis small-font" scope="col" data-sort="pest">Pest Name</th>
            ...
            <tbody class="table-group-divider fw-bold overflow-scroll">
                ...
                $query = "SELECT * FROM pest_resistance
                WHERE 1=1 $search_condition
                ORDER BY pest_resistance_id DESC 
                ...
                ?>
                        <tr>
                            <input type="hidden" name="pest_resistance_id" value="<?= $row['pest_resistance_id']; ?>">
                            ...
                            <td class="text-end">
                                <div class="dropdown row-btn">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li>
                                            <a class="dropdown-item edit_data admin-only" href="#" data-bs-toggle="modal" data-bs-target="#edit-item-modal" data-id="<?= $row['pest_resistance_id']; ?>"><i class="fa-solid fa-pen-to-square text-center me-1 admin-only" style="width: 20px;"></i>Edit</a>
                                        </li>
