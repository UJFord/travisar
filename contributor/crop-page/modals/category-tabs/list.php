...
<div class="col">
    <div class="container">
        ...
        <div class="d-flex justify-content-between">
            <!-- title -->
            <h4 class="fw-semibold" style="font-size: 1.5rem;">Crop Category</h4>
        ...
        $total_rows_query = "SELECT COUNT(*) FROM category";
        ...
        $search_condition = $search ? "AND category_name ILIKE '%$search%'" : '';
                            ...
                            <td class="text-end">
                                <div class="dropdown row-btn">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li>
                                            <a class="dropdown-item edit_data admin-only" href="#" data-bs-toggle="modal" data-bs-target="#edit-item-modal" data-id="<?= $row['category_id']; ?>"><i class="fa-solid fa-pen-to-square text-center me-1 admin-only" style="width: 20px;"></i>Edit</a>
                                        </li>
