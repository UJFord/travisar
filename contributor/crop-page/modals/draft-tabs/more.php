...
<div class="fade tab-pane" id="draft-more-tab-pane" role="tabpanel" aria-labelledby="draft-more-tab" tabindex="0">
    ...
    <?php require "modals/draft-tabs/traits/corn-traits.php" ?>
    <!-- rice morphological traits -->
    <?php require "modals/draft-tabs/traits/rice-traits.php" ?>
    <!-- root crop morphological traits -->
    <?php require "modals/draft-tabs/traits/rootCrop-traits.php" ?>
