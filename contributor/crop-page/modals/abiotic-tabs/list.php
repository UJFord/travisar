...
<div class="col">
    <div class="container">
        ...
        $total_rows_query = "SELECT COUNT(*) FROM abiotic_resistance";
        ...
        $search_condition = $search ? "AND abiotic_name ILIKE '%$search%'" : '';
        ?>
        ...
        <table id="dataTable" class="table table-hover">
            ...
            <thead>
                <tr>
                    ...
                    <th class="col text-dark-emphasis small-font" scope="col" data-sort="abiotic">abiotic Name</th>
            ...
            <tbody class="table-group-divider fw-bold overflow-scroll">
                ...
                $query = "SELECT * FROM abiotic_resistance
                WHERE 1=1 $search_condition
                ORDER BY abiotic_resistance_id DESC
                ...
                ?>
                        <tr>
                            <input type="hidden" name="abiotic_resistance_id" value="<?= $row['abiotic_resistance_id']; ?>">
                            ...
                            <td data-col="abiotic">
                                <div class="">
                                    <h6 class="m-0 small-font"><?= $row['abiotic_name'] ?></h6>
                                </div>
                            </td>
                            ...
                            <td class="text-end">
                                <div class="dropdown row-btn">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li>
                                            <a class="dropdown-item edit_data admin-only" href="#" data-bs-toggle="modal" data-bs-target="#edit-item-modal" data-id="<?= $row['abiotic_resistance_id']; ?>"><i class="fa-solid fa-pen-to-square text-center me-1 admin-only" style="width: 20px;"></i>Edit</a>
                                        </li>
