                    ...
                    <div class="container">
                        <div id="locationData">
                            ...
                            <div class="row mb-3 abiotic-row">
                                <!-- abiotic name -->
                                <div class="col-5">
                                    <label for="abiotic-Name" class="form-label small-font">Abiotic Name<span style="color: red;">*</span></label>
                                    <input type="text" name="abiotic_name_1" id="abiotic-Name" class="form-control">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        addRowButton.addEventListener('click', function() {
            ...
            newRow.innerHTML = `
                <div class="col-5">
                    <label for="abiotic-Name" class="form-label small-font">Abiotic Name<span style="color: red;">*</span></label>
                    <input type="text" name="abiotic_name_${rowCounter}" class="form-control">
