            ...
            <form id="form-panel-Edit" name="Form" action="modals/crud-code/terrain-code.php" autocomplete="off" method="POST" enctype="multipart/form-data" class=" py-3 px-5">
                <div class="modal-body" id="modal-body">
                    <div class="container">
                        <div id="Edit-User">
                            <!-- user id hidden -->
                            <input type="hidden" name="terrain_idEdit" id="terrain_idEdit">
                            <!-- terrain name-->
                            <div class="row mb-3">
                                <!-- terrain name -->
                                <div class="col">
                ...
                <!-- confirm -->
                <?php require "modals/terrain-tabs/confirm.php"; ?>
...
<script>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $.each(response, function(key, value) {
                        ...
                        // crop_id
                        $('#terrain_idEdit').val(id);
                        $('#terrain-NameEdit').val(value['terrain_name']);
                    });
                },
    ...
    function validateFormEdit() {
        ...
        if (terrain_name === "" || terrain_name === null) {
...
<script>
    ...
    document.getElementById('confirmDeleteBtnEdit').addEventListener('click', function() {
        // Send a request to delete the terrain
        $.ajax({
            url: 'modals/crud-code/terrain-code.php',
            type: 'POST',
            data: {
                'delete': 'delete',
                'terrain_id': document.getElementById('terrain_idEdit').value
            },
            success: function(response) {
