...
<div class="fade tab-pane" id="edit-more-tab-pane" role="tabpanel" aria-labelledby="edit-more-tab" tabindex="0">
    ...
    <?php require "edit-tabs/edit-traits/corn-traits-edit.php" ?>
    <!-- rice morphological traits -->
    <?php require "edit-tabs/edit-traits/rice-traits-edit.php" ?>
    <!-- rootCrop morphological traits -->
    <?php require "edit-tabs/edit-traits/rootCrop-traits-edit.php" ?>
