...
<div class="modal fade" id="draft-item-modal" tabindex="-1" aria-labelledby="draft-label" aria-hidden="true" data-bs-backdrop="static" data-bs-keyboard="false">
    ...
    <div class="modal-dialog modal-lg modal-fullscreen-sm-down">
        <div class="modal-content">
            ...
            <!-- body -->
            <form id="form-panel-draft" name="Form" action="crud-code/draft-code.php" autocomplete="off" method="POST" enctype="multipart/form-data" class="py-3 px-5">
...
<script>
    ...
    tableRowsDraft.forEach(row => {
        ...
        row.addEventListener('click', () => {
            ...
            $.ajax({
                url: 'fetch/fetch_crop-draft.php',
                type: 'POST',
                data: {
                    ...
                    $.each(response, function(key, value) {
                        ...
                        if (value['crop_seed_image'] != null && value['crop_seed_image'] != '') {
                            ...
                            imageFilenamesSeedDraft.forEach(function(filename) {
                                $('#previewSeedDraft').append(`<img src="img/${filename.trim()}" class="m-2 img-thumbnail" style="height: 200px;">`);
                            });
                        }
                        ...
                        if (value['crop_vegetative_image'] != null && value['crop_vegetative_image'] != '') {
                            ...
                            imageFilenamesVegDraft.forEach(function(filename) {
                                $('#previewVegDraft').append(`<img src="img/${filename.trim()}" class="m-2 img-thumbnail" style="height: 200px;">`);
                            });
                        }
                        ...
                        if (value['crop_reproductive_image'] != null && value['crop_reproductive_image'] != '') {
                            ...
                            imageFilenamesReproDraft.forEach(function(filename) {
                                $('#previewReproductiveDraft').append(`<img src="img/${filename.trim()}" class="m-2 img-thumbnail" style="height: 200px;">`);
                            });
                        }
                        ...
                        if (value['category_name'] === 'Corn') {
                            ...
                            $('#volExpansionDraft').prop('checked',
                            ...
                            $('#glutinousityDraft').prop('checked',
                                value['glutinous'] === '1' ||
...
<script>
    ...
    function fetchVarietiesDraft(categoryIdDraft) {
        ...
        xhrDraft.open('GET', 'fetch/fetch_varieties.php?category_id=' + categoryIdDraft, true);
        xhrDraft.send();
    }
