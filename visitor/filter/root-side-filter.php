    ...
    <div id="side-filter" class=" d-flex flex-column rounded border overflow-y-auto p-0">
        ...
        <div class="py-2 px-3" id="variety-div">
            ...
            <div id="variety-filters" class="collapse  mb-2">
                <?php
                $query = "SELECT * FROM category_variety where category_id = 2 order by category_variety_name ASC";
                ...
                ?>
                        <!-- category filters -->
                        <div id="variety-filters" class="collapse ps-4 mb-2">
...
<script>
    ...
    function toggleClearButtonVisibility() {
        ...
        let varietyCheckboxes = document.querySelectorAll('.variety-filter:checked');
        let selectedMunicipalityCheckboxes = document.querySelectorAll('.municipality-filter:checked');
        let selectedTerrainCheckboxes = document.querySelectorAll('.terrain-filter:checked');
        let searchInput = document.getElementById('searchInput').value.trim();

        if (varietyCheckboxes.length > 0 || selectedMunicipalityCheckboxes.length > 0 || selectedTerrainCheckboxes.length > 0 || searchInput !== '') {
    ...
    document.querySelectorAll('.variety-filter, .municipality-filter, .terrain-filter').forEach(checkbox => {
